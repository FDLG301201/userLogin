        ...
        <div className="w-[50%] max-w-xs pr-4">
          <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <a className="inline-block align-baseline font-bold text-sm text-red-500 hover:text-red-800"
            ...
            {/* Enlace "Register Now" */}
            <a className="block text-center text-sm text-blue-500 hover:text-blue-800"
              onClick={toRegister}
            >
              Register Now!
            </a>
